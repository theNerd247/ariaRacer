...
buildErrorPage :: RacerId -> AS.ScriptLogData -> H.Html
buildErrorPage rid log = appTemplate "Build Error" $ do
  BH.jumbotron (H.string "Error Occured While Building Your Code") $
